    ...
    <StickyBottomBar>
      <div className="flex items-center justify-between gap-3">
        <div className="min-w-0 flex-1">
          <div className="text-xs text-muted-foreground">{t('session:selectionBar.selectedCount', { n: seats.length })}</div>
        ...
        <div className="text-right shrink-0">
          <div className="text-xs text-muted-foreground">{t('session:selectionBar.total')}</div>
